from python.sampling import load_mean_and_cov, unconditional_samples, \
    substract_params, fix_true_params, params_to_respy
...
def sobol_indices(n_samples, seed, len_alp, sampling_method="random",):

    x_3, input_x_respy = _sobol_inputs(
        n_samples, seed, sampling_method=sampling_method)
...
def _sobol_inputs(n_samples, seed, sampling_method):
    ...
    sample_x, _ = unconditional_samples(
        mean, cov, n_samples, seed, sampling_method,)
